...
void test_gmtime(int *tests_run, int *tests_fail)
{
  int result;
  struct tm tm0 = { 0, 0, 0, 1, 0, 70, 4, 0, 0 };
  time_t t = 0;
  result = test_gmtime_call(&t, &tm0);
  (*tests_run)++; (*tests_fail) += result;
  struct tm tmY2038 = { 7, 14, 3, 19, 0, 138, 2, 18, 0 };
  t = 0x7fffffff;
  result = test_gmtime_call(&t, &tmY2038);
  (*tests_run)++; (*tests_fail) += result;
  struct tm tmY2038p = { 8, 14, 3, 19, 0, 138, 2, 18, 0 };
  t++;
  result = test_gmtime_call(&t, &tmY2038p);
  (*tests_run)++; (*tests_fail) += result;
  t = 0x80000000;
  result = test_gmtime_call(&t, &tmY2038p);
  (*tests_run)++; (*tests_fail) += result;
